                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-3 p-1 bg-white/5 rounded-xl border border-white/5">
                      <button
                        ...
                        className={`py-2.5 rounded-lg text-sm font-bold tracking-wide transition-all duration-300 ${type === "Expense"
                      ...
                      <button
                        ...
                        className={`py-2.5 rounded-lg text-sm font-bold tracking-wide transition-all duration-300 ${type === "Income"
